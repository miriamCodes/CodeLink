...
const discussionboard_1 = require("./controllers/discussionboard");
...
router.put('/update-profile', profile_1.updateProfile); // MAYBE ALSO ADD ID
...
router.post('/project/:id/vote', discussionboard_1.postProjectVote);
